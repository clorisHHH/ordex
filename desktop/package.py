...
(code/'package.json').write_text('{"name":"ordex","productName":"Ordex","version":"1.0.0","main":"desktop/main.cjs"}')
...
p.update(CFBundleName='Ordex',CFBundleDisplayName='Ordex',CFBundleIdentifier='local.ordex.desktop',CFBundleExecutable='Ordex',CFBundleShortVersionString='1.0.0',CFBundleVersion='10000',CFBundleIconFile='ordex.icns')
...
target=outputs/'Ordex-macOS-arm64-zh-en-v1.0.0.dmg'
